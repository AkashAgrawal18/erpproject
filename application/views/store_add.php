	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				...
				<a href="<?php echo site_url('HrDept/store_list') ?>" class="btn btn-sm btn-info">Store List </a>
				</div>
			</div>
		</div><!-- /.container-fluid -->
	</section>
				...
				<?php if ($logged_user_type == 1 || has_perm($roll_id, 'HR', 'STRFCT', 'Add')) { ?>
							...
							<form method="post" action="#" id="frm-add-store">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-layout-submit">
											<a href="<?php echo site_url('HrDept/store_add') ?>" class="btn btn-block btn-danger">Cancel </a>
