								...
								<tbody>
									...
									?>
											<tr>
												...
												<td><?= $value->m_inv_cgst + $value->m_inv_sgst; ?></td>
												...
												<td title="Action" style="white-space: nowrap;">
													...
													<?PHP } ?>
													 	<a href="<?= site_url('Invoice/invoice_print?id=') . $value->m_inv_id; ?>" class="btn btn-success btn-sm" title="Print" ><i class="fa fa-print"></i></a>
