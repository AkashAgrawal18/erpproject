      ...
      <tbody>
        ...
        ?>
            <tr>
              ...
              <td><?= date('m/y',strtotime($kry->m_batch_date .' +'.$kry->m_batch_expiry.' months')) ?></td>
              <!-- <td>17011310</td> -->
  ...
  <?php if ($printtype == 1) { ?>
    <script>
      window.onload = function() {
        ...
        html2pdf()
          .from(element) // Select the element to convert
          .save('<?= $fileName ?>'); // Set the filename for the PDF
        setTimeout(function() {
          window.history.back();
        }, 2000);
      }
