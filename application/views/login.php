				...
				<div class="card-body login-card-body">
					<div class="row">
						<div class="col-sm-12">
							...
							<form action='<?php echo base_url('Login') ?>' id="formAuthentication" method="post">
								...
								<div class="input-group mb-2">
									<input type="password" class="form-control" required="true" value="<?php echo set_value('login_pass'); ?>"
										name="login_pass" id="login_pass" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
										aria-describedby="password">
									<div class="input-group-append">
										<div class="input-group-text">
											<span>
												<i class='fa fa-eye input-icon' id="togglePassword" aria-hidden='true'
													data-change0='fa fa-eye' data-change='fa fa-eye-slash' title="Click here"></i>
											</span>
										</div>
									</div>
								</div>
              ...
              <label for="remember">
                Remember Me
									...
									<div class="col-4 text-right">
										<button type='button' id="btn-login" class="btn btn-primary btn-block" onclick="validateCaptcha()">Login</button>
									</div>
									<!-- /.col -->
								</div>
