            ...
            <div class="col-sm-12">
              ...
              <form action='<?php echo base_url('Login') ?>' id="formAuthentication" method="post">
                ...
                <div class="input-group mb-2">
                  <input type="password" class="form-control" required="true" value="<?php echo set_value('login_pass'); ?>" name="login_pass" id="login_pass" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password">
                  <div class="input-group-append">
                    <div class="input-group-text">
